  ...
  return (
    <Fragment>
      ...
      <div style={{
        ...
        <div style={{ position: 'absolute', top: '8px', right: '12px', fontSize: '12px', color: '#1a73e8', fontWeight: 'bold', border: '1px solid #1a73e8', padding: '2px 4px', borderRadius: '4px' }}>v1.0.3</div>
